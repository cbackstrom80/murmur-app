...
| # | Preset | Playing tip |
|---|--------|-------------|
| 001 | **CATHEDRAL NEBULA** | Hold C3–C4; mod wheel blooms filter + WT morph. Best with long reverb tail. |
| 002 | **DUST LANE HYMN** | Legato chords in low-mid register; pressure swells level and space. |
| 003 | **ORGAN OF VOID** | Pipe-organ weight — play octaves C2–C3; macro MORPH opens vowel formant. |
| 016 | **BLACK HOLE GRAVITY** | Sub register C1–C2; mod wheel adds harmonics without mud. |
| 038 | **CORNFIELD CHASE** | Lead lines G3–B4; portamento on legato; tape delay carries melody. |
| 028 | **TICKING ETERNITY** | Enable arp latch; short staccato in mid register for clock tension. |
| 048 | **DEEP SPACE DRIFT** | Single held note anywhere — granular cloud evolves over 10s. |
| 058 | **WORMHOLE RISE** | FX: sweep mod wheel up over 4 bars for riser; release for impact tail. |
| 068 | **EXOPLANET KEYS** | Crystalline plucks C4–C5; velocity opens brightness. |
| 086 | **DUAL CATHEDRAL** | Stack mode — macro MORPH balances organ + nebula layers. |

## Categories (10 × 10)

### Nebulae & Cosmic Cathedrals

Emission/reflection nebulae, organ-weight pads, ionized gas swells.
...
Hubble deep-field drift, gravity-well pads, pale-blue perspective.
...
Event horizon bass, singularity pulses, Penrose process low end.
...
Millisecond pulsar grids, lighthouse beacons, relativistic clock rhythms.
...
Cornfield chase energy, ranger themes, Contact/Golden Record melodic lines.
...
CMB hum, heliopause, magnetosphere, quasar drone textures.
...
Wormhole risers, hyperdrive sweeps, docking/airlock FX.
...
| 068 | `exoplanet-keys.pw8` | seq | Classic, Resonator | Staccato C4–C5 |
| 069 | `cryo-pluck.pw8` | seq | Classic, FM | Staccato C4–C5 |
| 070 | `ice-moon-arp.pw8` | seq | Classic, Wavetable | Staccato C4–C5 |

### Exoplanets & Ice Moons

Cryo plucks, Europa glass, Titan atmosphere keys.
...
| 075 | `ceres-crystal.pw8` | seq | Classic, PhaseShape | Staccato C4–C5 |
| 076 | `io-spark.pw8` | seq | Classic, Resonator | Staccato C4–C5 |
| 077 | `ganymede-tide.pw8` | seq | Classic, FM | Staccato C4–C5 |
| 078 | `orbital-chime.pw8` | seq | Wavetable, FM, Warp | Single strikes C5–C7 |
| 079 | `debris-strike.pw8` | seq | Wavetable, FM, Warp | Single strikes C5–C7 |
| 080 | `satellite-bell.pw8` | seq | Wavetable, FM, Warp | Single strikes C5–C7 |

### Orbital Bells & Rings

Satellite chimes, comet tails, ring-particle mallets.

| # | File | Role | Engine highlight | Inspiration |
|---|------|------|------------------|-------------|
| 081 | `comet-tail.pw8` | seq | Wavetable, FM, Warp | Single strikes C5–C7 |
| 082 | `ring-particle.pw8` | seq | Wavetable, FM, Warp | Single strikes C5–C7 |
...
| 090 | `twin-nebula.pw8` | pad | Classic, Additive, PhaseShape, Filter2, Stack | Chords in mid register |

### Spacetime & Quantum Edge

Dual-layer stacks, multiverse folds, Hawking radiation wildcards.
...
Authored by MURMUR Sound Design. Batch tag: `interstellar`.
