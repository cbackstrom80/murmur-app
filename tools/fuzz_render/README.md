...
**IMPLEMENTED.** `murmur-fuzz-render`: generates random-but-schema-valid patches
...
```bash
./build/dev/tools/murmur-fuzz-render --count 10000 --seed 1 [--duration 1.5] [--sample-rate 48000] [--verbose] [--stop-on-first-failure]
```
