...
| [x] Pixel-match `MurmurChromeBar` FR.STEP badge (300ms fade, keyframe name flash, collision rules) | `89:1763` `murmur-mi-ui-chrome-fr-step-badge` | `MurmurChromeBar.cpp`, `PatchworkEightProcessor.cpp` | FR.STEP detector | Automate morph sweep; badge flashes at crossings |
