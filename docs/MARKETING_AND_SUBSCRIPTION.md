...
synth packs (top of funnel) and **Starfighter** (moat + retention).

## Hierarchy

```
Patchwork Audio          company (legal, billing, support)
├── Starfighter          instrument brand (VST, .pw8 native)
...
**Upgrade SKU:** **Patchwork Pro** ($49/mo) — Plus + Starfighter license + commercial use.
...
| `/patches` | Unified catalog (VITAL · Starfighter · future formats) |
...
4. **Pro upgrade** — Starfighter license bundled.
