...
| 10 | Additional engines (additive, phase/shape, noise, resonator, granular) | **PARTIAL** -- PhaseShape (Engine Type 5) **IMPLEMENTED** this pass: CZ-style phase distortion + wavefold, see DSP_ENGINE.md. Additive, NoiseChaos, Resonator, Granular still render silence until implemented |
