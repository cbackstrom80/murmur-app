...
| 10 | Additional engines (additive, phase/shape, noise, resonator, granular) | **PARTIAL** -- NoiseChaos (Engine Type 7) **IMPLEMENTED** this pass: 7 variants (white/pink/brown/blue/S&H/smooth-random/dust), seeded via `dsp::DeterministicRng`, see DSP_ENGINE.md. Additive, PhaseShape, Granular, Resonator still render silence until implemented |
