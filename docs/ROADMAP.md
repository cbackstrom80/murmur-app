...
| 10 | Additional engines (additive, phase/shape, noise, resonator, granular) | **PARTIAL** -- being built out one engine/PR at a time, in order of how much existing infrastructure each reuses; additive/phase-shape/noise/resonator/granular still render silence until their turn. (FM/PM, also once part of this phase, now ships under Phase 4 above.) |
