...
// zero allocation risk. That's 618 parameters: 8 macros, Filter1 (5), 8 LFOs x 5
// fields (40), 8 operators x 14 fields (112), 8 envelopes x 8 fields (64), layer
...
// count and running total across passes (8 -> 270 -> 361 -> 501 -> 578 -> 618,
// docs/ROADMAP.md).
//
...
namespace pw8::plugin
{
    ...
    inline constexpr std::size_t kNumOperatorFields = 14;
    ...
    /// all 618 parameters described above, generated from the field-spec tables
