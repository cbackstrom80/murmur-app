...
// zero allocation risk. That's 594 parameters: 8 macros, Filter1 (5), 8 LFOs x 5
// fields (40), 8 operators x 11 fields (88), 8 envelopes x 8 fields (64), layer
...
// count and running total across passes (8 -> 270 -> 361 -> 501 -> 578 -> 594,
// docs/ROADMAP.md).
//
...
namespace pw8::plugin
{
    ...
    inline constexpr std::size_t kNumOperatorFields = 11;
    ...
    /// all 594 parameters described above, generated from the field-spec tables
